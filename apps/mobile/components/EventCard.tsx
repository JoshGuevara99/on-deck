      ...
      <View style={styles.content}>
        ...
        <View style={styles.footer}>
          {event.isRecurring && event.recurringDescription && (
            <FooterChip icon="repeat" label={event.recurringDescription} />
          )}
          {event.slotDuration && (
            <FooterChip icon="time-outline" label={event.slotDuration} />
          )}
          <FooterChip
          ...
          {event.signUpMethod === 'door' && (
            <FooterChip icon="hand-left-outline" label="Sign up at door" />
          )}
        </View>
      </View>
    </TouchableOpacity>
...
function FooterChip({ icon, label }: { icon: string; label: string }) {
  return (
